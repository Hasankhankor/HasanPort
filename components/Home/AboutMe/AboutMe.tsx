        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0  md:space-x-8 sm:space-x-2 ">
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              ...
              Hello, my name is Hassan Tariq.

I am a dedicated software engineer and problem solver, committed to creating impactful code that thrives on the internet. I embarked on my software journey four years ago, and since then, I have worked on various web applications including Learning Management Systems (LMS), wedding halls booking apps, e-commerce stores, and dynamic news websites. Additionally, I have experience in developing mobile applications using React Native.
              </span>
            </div>
            <div className="font-Header ">
              <span className="text-gray-400 ">
                ...
                <span className="text-AAsecondary">AWS EC2</span>, where I played a key role in releasing v2 of{" "}
